...
// .empty() empties the HTML contents of a jQuery DOM objectx
...
let current_icon = icon(response.currently.icon)
$("#current-conditions-icon").append(current_icon)

let current_text = response.currently.summary
$("#current-conditions-text").append(current_text)
